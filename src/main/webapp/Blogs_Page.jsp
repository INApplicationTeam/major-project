    ...
    <main>
        ...
        <div class="container mt-2">
            <div class="row">
                <!--Main column-->
                <div class="col-lg-8">
                	<h1 class="h1-responsive animated fadeInDown" style="font-size: 72px;">Blogs <span style="font-size: 50px;float: right;"><small class="text-muted"><%= dname %></small></span></h1>
