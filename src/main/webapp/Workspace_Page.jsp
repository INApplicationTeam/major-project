...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav1">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item"><a href="MyFeed" class="nav-link">Home
							<span class="sr-only">(current)</span>
					</a></li>
					<li class="nav-item"><a href="MyProfile" class="nav-link">Profile</a>
					</li>
					<li class="nav-item"><a
						href="BlogContent?did=<%= dcm.getDid() %>" class="nav-link">Blogs</a>
					</li>
				...
				<form action="AskQuestion"
					...
					<br> <input id="search" name="search"
						class="form-control search" type="text"
	...
	<!--Carousel Wrapper-->
	<div id="carousel-example-3" class="carousel slide carousel-fade"
		...
		<div class="carousel-inner" role="listbox">
			...
			<!-- First slide -->
			<div class="carousel-item active view hm-black-strong"
				style="background-image: url('img/testd.jpg'); background-repeat: repeat-x;">
				...
				<div class="full-bg-img flex-center">
					<div class="animated fadeIn col-md-12">
						<div class="row mt-4">
							...
							<div class="col-md-2">
								<img class="img-responsive rounded-circle img-fluid mb-4 mt-1"
									src="imagesdomain/<%= dcm.getImagePath() %>"
							...
							<div class="col-md-4 text-center">
								<ul class="animated fadeIn col-md-12">
									<li>
										<h1 class="h1-responsive lead mt-1" style="font-weight: bold;"><%= dcm.getDname() %>
										</h1>
									</li>
									<li>
										<p>
											Followers <label id="followers" class="badge blue"><%= dcm.getFollowersCount() %></label>
											| Tags <label class="badge blue"><%= dcm.getTagCount() %></label>
										</p>

									</li>
									<li><input type="button" class="btn btn-info btn-sm"
										id="followbtn" onclick="follow(<%=dcm.getDid()%>)"></li>
								</ul>
							</div>
							<div class="col-md-3">
								<ul class="animated fadeIn col-md-12 mt-1">
									<li>
										<h2 class="h2-responsive mt-2" style="margin-top: 30px;">
											<i class="fa fa-bookmark"></i> Top Users
										</h2>
									</li>
									<li><br> <%
			...
			<!-- Second slide -->
			<div class="carousel-item view hm-cyan-strong"
				style="background-image: url('img/testd.jpg'); background-repeat: no-repeat; background-size: cover;">
							...
							<div class="col-md-3 text-center">
								<li><br>
									<h1 class="h1-responsive"
										style="font-weight: bold; color: #000000;">Trending Top
										tags:</h1></li>
			...
			<!-- Third slide -->
			<div class="carousel-item view hm-black-strong"
				style="background-image: url('img/testd.jpg'); background-repeat: no-repeat; background-size: cover;">
					...
					<ul class="animated fadeIn col-md-12">
						<div class="row">
							...
							<div class="col-md-3">
								...
								<li><h2 class="h2-responsive">
										<label class="badge blue"><%= dcm.getQuestionsCount() %></label>
									</h2></li>
							</div>
							<div class="col-md-4">
								<li><h1 class="h1-responsive">Total question Answered</h1></li>
								<li><h2 class="h2-responsive">
										<label class="badge blue"><%= dcm.getAnswersCount() %></label>
									</h2></li>
							...
							<div class="col-md-3">
								...
								<li><h2 class="h2-responsive">
										<label class="badge blue"><%= dcm.getBlogsCount() %></label>
									</h2></li>
				...
				<div class="card wow fadeIn" data-wow-delay="0.2s">
					<div class="card-block">
						<a href="UserProfile?uid=<%= qm.getUid() %>"
							...
							class="badge blue"><a style="color: #FFFFFF;"> <%= dcm.getDname() %></a></label>
						with
						...
						<div class="row" style="padding-left: 5px;">
							...
							<div class="col-md-1 col-sm-1">
								<img src="ImageLoader?uid=<%= qm.getTopAnswerer() %>"
									alt="Circle Image" class="rounded-circle img-responsive">
							</div>
	...
	<footer class="page-footer center-on-small-only mt-3" id="footer">
		...
		<div class="container-fluid text-center" style="padding-bottom: 10px;">
			© 2017 Made with <i class="fa fa-heart" aria-hidden="true"
				style="color: #ff4444;"></i> by team Korero
		</div>
		<!--/.Copyright-->
