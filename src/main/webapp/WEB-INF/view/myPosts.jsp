...
-->
                    ...
                    <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-pull-right mr-3">
                                <a class="dropdown-item" href="showMyQuestions">My Questions</a>
                                <a class="dropdown-item" href="showMyEvents">My Events</a>
                                <a class="dropdown-item" href="showMyDiscussions">My Discussions</a>
                                <a class="dropdown-item" href="showMyPolls">My Polls</a>
                            </div>
                        </div>
            ...
            <div class="row wow fadeIn">
                ...
                <div class="col-md-9">
            <c:if test="${postType=='question'}">                         
            	<c:set var="countQue" value="-1" scope="page" />
				<c:forEach var="posts" items="${allMyPosts}" begin="0" varStatus="postLoop">
