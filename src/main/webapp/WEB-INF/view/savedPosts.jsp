			...
			<div class="card mb-3 mt-3">
				<div class="card-body pb-0">
					<small> <a href="">${posts.userModel.uname}</a> created this poll 
						   <a class="blue-text" onclick="unSave('${posts.queid}','${postLoop.index}');"><i class="fa fa-bookmark float-right mr-3" aria-hidden="true"></i></a>
					</small> <strong>
                    ...
                    <div class="card mb-3 mt-3">
                        <div class="card-body pb-0">
                            <small>
                                ...
                                <a class="blue-text" onclick="unSave('${posts.id}','${postLoop.index}');"><i class="fa fa-bookmark float-right mr-3" aria-hidden="true"></i></a>
                            </small>
                        ...
                        <c:forEach var="classComment" items="${posts.classCommentList}" begin="0" varStatus="innerloop">
                    ...
                    <div class="card mb-3">
                        <div class="card-body pb-2">
                            <small>
                                ...
                                <a class="blue-text" onclick="unSave('${posts.eid}','${postLoop.index}');"><i class="fa fa-bookmark float-right mr-3" aria-hidden="true"></i></a>
                            </small>
                            <h4 style="font-size: 24px;" class="mt-2"><a>${posts.title}</a></h4>
                            <small>
                                <strong>Description: </strong>
